...
//
// 1. As of MySQL 5 'TYPE' has been deprecated in favour of 'ENGINE' for specifying the database engine to use. I am reluctant to 'hard code' this change into the following statements through fear of causing compatibility problems on servers running older versions of MySQL, so for the purposes of backward compatibility I have included an easy way to default back to the old syntax here
...
) ".$engineSyntax."=MyISAM;") or die("Error - database already exists! If you want to create a new database delete the old one first.");
